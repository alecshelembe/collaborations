...
const API_BASE_URL = "https://cash-crusaders.visitmyjoburg.co.za/api";
const STORAGE_BASE_URL = "https://cash-crusaders.visitmyjoburg.co.za/storage/";
  ...
  const renderUserCard = ({ item }: { item: User }) => (
    <View style={styles.card}>
      <View style={styles.profileImageContainer}>
        <Image source={{ uri: STORAGE_BASE_URL + item.profile_image_url }} style={styles.profileImage} />      </View>
      <View style={styles.profileInfo}>
        ...
        <View style={styles.socialLinks}>
          ...
          {item.other_handle && (
            <TouchableOpacity onPress={() => handleLinkPress(`${item.other_handle}`)}>
              <FontAwesome name="link" size={20} color="black" style={styles.socialIcon} />
            </TouchableOpacity>
          )}

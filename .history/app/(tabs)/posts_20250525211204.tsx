...
// Define your theme color for the background
const BRAND_BACKGROUND_COLOR = '#1a1a1a'; // Using the same dark background color from BookingPage
...
const SciencePostsPage = () => {
  ...
  if (loading) {
    return (
      <View style={styles.screenContainer}> {/* Apply theme background to loading screen */}
        <View style={styles.centeredCard}> {/* Place ActivityIndicator in a centered card */}
...
const styles = StyleSheet.create({
  ...
  centeredCard: { // New style for the loading indicator card
    ...
    alignItems: 'center',
    margin: 16, // Apply card margin even for the loading state
    backgroundColor: '#fff', // White background for the loading card
    borderRadius: 10,
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.1,

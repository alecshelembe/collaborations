  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.notificationText}>We follow a strict data protection policy. User accounts are removed after a long period of inactivity. NB Please use an active email address. </Text>

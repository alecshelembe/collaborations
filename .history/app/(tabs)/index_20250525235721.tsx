...
const STORAGE_BASE_URL = 'https://atamela.visitmyjoburg.co.za/storage';
const IMAGE_BASE_URL = 'https://atamela.visitmyjoburg.co.za'; // For images that aren't in /storage
